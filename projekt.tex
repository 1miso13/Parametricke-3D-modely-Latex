...
\projectinfo{
  ...
  keywords.cs={parametrické modely, 3D, grafika}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={parametric models, 3D, graphics}, % klíčová slova v anglickém jazyce / keywords in english
  %keywords.en={Here, individual keywords separated by commas will be written in English.},
  % Abstrakt / Abstract
  abstract.cs={
Cieľom tejto práce je vytvoriť aplikáciu na tvorbu parametrických 3D modelov. Parametrické modelovanie využíva rôzne geometrické operácie na tvorbu modelov a umožňuje zmenu ich hodnôt, tzv. parametrov, v ľubovolnom čase.}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
  abstract.en={The aim of this work is to create an application for creating parametric 3D models. Parametric modeling uses various geometric modeling operations for creation and also it enables to change the values, so called parameters, of these models at any time.}, % abstrakt v anglickém jazyce / abstract in english
